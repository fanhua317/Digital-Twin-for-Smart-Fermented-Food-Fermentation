...
export const simulationApi = {
  ...
  getEquipments: () => api.get('/simulation/equipments'),
  getAgvs: () => api.get('/simulation/agvs'),
...
export const productionApi = {
  ...
  completeBatch: (id: number, actualVolume: number, qualityScore: number) =>
    api.put(`/production/batches/${id}/complete`, null, {
      params: { actual_volume: actualVolume, quality_score: qualityScore }
    }),
